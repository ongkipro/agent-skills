...
Always import from `@shopify/ui-extensions/point-of-sale` — **never** from `@shopify/pos-ui-extensions`, `@shopify/polaris-web-components`, `@shopify/polaris-web-components/pos`, or any other package. Those packages do not exist.
