...
Always import from `@shopify/ui-extensions/customer-account` — **never** from `@shopify/customer-account-ui-extensions`, `@shopify/customer-account-ui-extensions-react`, `@shopify/polaris-web-components`, or any other package. Those packages do not exist.

```ts
import { extension, Banner, BlockStack } from '@shopify/ui-extensions/customer-account';
```
...
import { useExtensionCapability } from '@shopify/ui-extensions-react/customer-account';
```
